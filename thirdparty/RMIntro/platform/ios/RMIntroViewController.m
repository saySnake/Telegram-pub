...
//        _descriptions = @[TGLocalized(@"Tour.Text1"), TGLocalized(@"Tour.Text2"),  TGLocalized(@"Tour.Text6"), TGLocalized(@"Tour.Text3"), TGLocalized(@"Tour.Text4"), TGLocalized(@"Tour.Text5")];
        ...
        _headlines = @[ TGLocalized(@"Tour.Title1"), TGLocalized(@"Tour.Title2"), TGLocalized(@"Tour.Title3"), TGLocalized(@"Tour.Title4")];
        _descriptions = @[TGLocalized(@"Tour.Text1"), TGLocalized(@"Tour.Text2"), TGLocalized(@"Tour.Text3"), TGLocalized(@"Tour.Text4")];
...
- (void)setupGL
{
    ...
    set_telegram_textures(setup_texture(@"telegram_sphere.png"), setup_texture(@"talk_spheree.png"));
