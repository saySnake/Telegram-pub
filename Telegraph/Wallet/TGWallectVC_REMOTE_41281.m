...
@property (weak, nonatomic) IBOutlet UILabel *detaileLabel; //详细钱
...
@property (weak, nonatomic) IBOutlet UIButton *payButton;  //付款
@property (weak, nonatomic) IBOutlet UIButton *receiptButton; //收款
...
- (void)setUpHeadView
{
    ...
    pageMenu.selectedItemTitleColor =RGBACOLOR(4.0f, 159.0f, 246.0f, 1);
    pageMenu.unSelectedItemTitleColor =RGBACOLOR(142.0f, 142.0f, 147.0f, 1);
...
{
    HBPaymentViewController *payVC = [[HBPaymentViewController alloc] init];
    [self.navigationController pushViewController:payVC animated:YES];
}

-(IBAction)receipt:(id)sender
{
    HBReceiptViewController *receiptVC = [[HBReceiptViewController alloc] init];
